...
def translate_text(text, src_lang, dest_lang, mode):
    """Traduire le texte avec Google Translate"""
    try:
        # Créer un nouveau traducteur à chaque fois pour éviter les problèmes async
        ...
        return translation.text, cultural_context
